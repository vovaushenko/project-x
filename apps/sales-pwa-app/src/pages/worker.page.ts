...
export class WorkerPage extends LitElement {
	render() {
		return html`<section>
			...
			<av-button
				label="Slow Fibonacci"
				@click=${this._expensiveOperation}
				type="error"
			></av-button>
			<h3>
				Fibonacci: ${this.fibonacciResult} Operation took:
				${this.fibonacciOperationTime}ms
			</h3>

			<av-button
				label="Fibonacci in Worker"
